...
Всего я проведу по 20 испытаний для случайных 
...
if __name__ == '__main__':
    ...
    незначительный прирост у Быстрой сортировки и то же время осталось у сортировки кучей.
    ...
    списками. Выводы сделаны в файле SortingAlgorithms.py.'''
